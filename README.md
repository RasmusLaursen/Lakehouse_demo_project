...
The 'lakehouse_demo_project' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] lakehouse_demo_project_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/lakehouse_demo_project.job.yml). The schedule
