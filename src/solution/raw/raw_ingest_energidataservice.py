"""Raw layer ingestion pipeline for energidataservice source system.
...
# Create the raw pipeline for energidataservice source system
create_raw_pipeline("energidataservice")
