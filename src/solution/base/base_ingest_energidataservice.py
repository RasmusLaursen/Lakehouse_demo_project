"""Base layer CDC pipeline for energidataservice source system.
...
# Create the base pipeline for energidataservice source system
create_base_pipeline("energidataservice")
